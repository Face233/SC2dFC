...
> 历史计划（非当前执行清单）：Huber 对应 E0004–E0007、E0009–E0012；E0008 显式使用 MSE，E0013 及后续实验须逐项核对冻结配置和 checkpoint。部分本计划中的“当前”“下一阶段”是 2026-08-17 当时的表述，当前进度见[项目状态](project_status.md)。
