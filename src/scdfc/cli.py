...
def build_parser() -> argparse.ArgumentParser:
    ...
    train.add_argument("--model", choices=["gru", "tcn", "transformer", "direct_mlp", "gcn_gru", "mlp", "lstm"], required=True)
    ...
    create.add_argument("--loss-type", choices=["mse", "huber"], default="mse")
    create.add_argument("--huber-beta", type=float, default=1.0, help="Smooth L1 beta; used only with --loss-type huber")
